...
Output: CSV with:
date, ticker, title, description, url, source, domain, provider

Quick usage:
    # GDELT-only (disable NewsAPI for this run)
    # PowerShell:  $env:NEWSAPI_KEY=""
    # bash/cmd:    set NEWSAPI_KEY=
    python news_ingest.py --start 2025-09-06 --end 2025-10-04 --tickers V JPM --out articles_V_JPM_gdelt.csv
"""
